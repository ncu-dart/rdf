...
'''
This script generates the SVDPP model with regularization differentiating function

After installation, you may run the following command:

$ rdfsvdpp-train [train-file]

This will generate a model file of the name [train-file]-rdfsvdpp-model.pck
'''
...
def save_model(m):
    ...
    with open('%s-rdfsvdpp-model.pck' % (filename_prefix), 'wb') as f_out:
        pickle.dump(m, f_out)
